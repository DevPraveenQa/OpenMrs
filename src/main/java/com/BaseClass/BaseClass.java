...
//4 getTitle()
	...
	// 11 sendkey()
	public static void sendkeys(WebDriver driver, WebElement element, String values) {
		element.clear();
	...
	// dropdown
	public static void dropdown(WebDriver driver, WebElement element, String name, String value, int index) {
